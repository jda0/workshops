 ...
 *	Modified by Scott Nugent and Will Price
 *
 */

#include "esp_dualStepper.h"
...
void DualStepper::setup(int leftMotor1,int leftMotor2 ,int leftMotor3 ,int leftMotor4 ,int rightMotor1 ,int rightMotor2 ,int rightMotor3 ,int rightMotor4){
